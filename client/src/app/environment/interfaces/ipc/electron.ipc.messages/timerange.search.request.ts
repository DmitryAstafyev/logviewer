import { DateTimeReplacements } from '@chipmunk/interfaces/interface.detect';
...
export class TimerangeSearchRequest {
	...
	constructor(params: ITimerangeSearchRequest) {
		...
		if (!(params.points instanceof Array) || params.points.length < 2) {
			throw new Error(
				`points should be defined as Array<ISearchExpression>. Shoud be defined at least 2 points.`,
			);
		}
