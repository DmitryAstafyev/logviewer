...
export interface IValidSearchChunk {
	guid: string;
	data: string;
	start: number;
	end: number;
...
export class SearchChunk {
	public static signature: string = 'SearchChunk';
	public signature: string = SearchChunk.signature;
	public guid: string;
	public data?: string;
	public start: number;
	public end: number;
	...
	constructor(params: ISearchChunk) {
		if (typeof params !== 'object' || params === null) {
			throw new Error(`Incorrect parameters for SearchChunk message`);
		}
