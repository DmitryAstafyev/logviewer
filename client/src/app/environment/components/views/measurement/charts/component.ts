                ...
                options: {
                    ...
                    animation: {
                        ...
                        onComplete: function () {
                            ...
                            ctx.font = fontString(
                                Chart.defaults.font.size === undefined ? 10 : Chart.defaults.font.size,
                                Chart.defaults.font.style === undefined ? "inherit" : Chart.defaults.font.style,
                                Chart.defaults.font.family === undefined ? "Arial" : Chart.defaults.font.family,
                            );
                            ctx.textAlign = 'right';
