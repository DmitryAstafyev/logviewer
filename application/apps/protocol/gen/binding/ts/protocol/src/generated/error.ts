...
export namespace error {
    ...
    export class GrabError extends pb_1.Message {
        ...
        static fromObject(data: {
            ...
            if (data.config != null) {
                message.config = GrabError.Config.fromObject(data.config as any);
            }
            if (data.communication != null) {
                message.communication = GrabError.Communication.fromObject(
                    data.communication as any,
                );
            }
            if (data.io_operation != null) {
                message.io_operation = GrabError.IoOperation.fromObject(data.io_operation as any);
            }
            if (data.invalid_range != null) {
                message.invalid_range = GrabError.InvalidRange.fromObject(
                    data.invalid_range as any,
                );
            }
            ...
            if (data.unsupported != null) {
                message.unsupported = GrabError.Unsupported.fromObject(data.unsupported as any);
            }
            return message;
        }
        toObject() {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_communication)
                writer.writeMessage(2, this.communication, () =>
                    this.communication.serialize(writer),
                );
            if (this.has_io_operation)
                writer.writeMessage(3, this.io_operation, () =>
                    this.io_operation.serialize(writer),
                );
            if (this.has_invalid_range)
                writer.writeMessage(4, this.invalid_range, () =>
                    this.invalid_range.serialize(writer),
                );
            ...
            if (this.has_not_initialize)
                writer.writeMessage(6, this.not_initialize, () =>
                    this.not_initialize.serialize(writer),
                );
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(
                            message.config,
                            () => (message.config = GrabError.Config.deserialize(reader)),
                        );
                        break;
                    case 2:
                        reader.readMessage(
                            ...
                            () =>
                                (message.communication =
                                    GrabError.Communication.deserialize(reader)),
                        );
                        break;
                    case 3:
                        reader.readMessage(
                            message.io_operation,
                            () =>
                                (message.io_operation = GrabError.IoOperation.deserialize(reader)),
                        );
                        break;
                    case 4:
                        reader.readMessage(
                            ...
                            () =>
                                (message.invalid_range =
                                    GrabError.InvalidRange.deserialize(reader)),
                        );
                        break;
                    case 5:
                        reader.readMessage(
                            message.interrupted,
                            () => (message.interrupted = GrabError.Interrupted.deserialize(reader)),
                        );
                        break;
                    case 6:
                        reader.readMessage(
                            message.not_initialize,
                            () =>
                                (message.not_initialize =
                                    GrabError.NotInitialize.deserialize(reader)),
                        );
                        break;
                    case 7:
                        reader.readMessage(
                            message.unsupported,
                            () => (message.unsupported = GrabError.Unsupported.deserialize(reader)),
                        );
                        break;
                    default:
                        reader.skipField();
    ...
    export namespace GrabError {
        export class Config extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): Config {
            ...
            serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
                const writer = w || new pb_1.BinaryWriter();
                if (this.has_message && this.message.length) writer.writeString(1, this.message);
                if (!w) return writer.getResultBuffer();
            }
        ...
        export class Communication extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): Communication {
        ...
        export class IoOperation extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): IoOperation {
        ...
        export class InvalidRange extends pb_1.Message {
            ...
            get range() {
                return pb_1.Message.getWrapperField(
                    this,
                    dependency_1.common.RangeInclusive,
                    1,
                ) as dependency_1.common.RangeInclusive;
            }
            ...
            static fromObject(data: {
                ...
                const message = new InvalidRange({
                    range: dependency_1.common.RangeInclusive.fromObject(data.range as any),
            ...
            toObject() {
                const data: {
                    range?: ReturnType<
                        typeof dependency_1.common.RangeInclusive.prototype.toObject
                    >;
                    context?: string;
                } = {};
                if (this.range != null) {
            ...
            serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
                ...
                if (this.has_context && this.context.length) writer.writeString(2, this.context);
                if (!w) return writer.getResultBuffer();
            }
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): InvalidRange {
                const reader =
                        bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                    message = new InvalidRange();
                while (reader.nextField()) {
                    if (reader.isEndGroup()) break;
                    switch (reader.getFieldNumber()) {
                        case 1:
                            reader.readMessage(
                                ...
                                () =>
                                    (message.range =
                                        dependency_1.common.RangeInclusive.deserialize(reader)),
                            );
                            break;
                        case 2:
        ...
        export class Unsupported extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): Unsupported {
    ...
    export class SearchError extends pb_1.Message {
        ...
        static fromObject(data: {
            ...
            if (data.config != null) {
                message.config = SearchError.Config.fromObject(data.config as any);
            }
            if (data.communication != null) {
                message.communication = SearchError.Communication.fromObject(
                    data.communication as any,
                );
            }
            if (data.io_operation != null) {
                message.io_operation = SearchError.IoOperation.fromObject(data.io_operation as any);
            }
            if (data.regex != null) {
                message.regex = SearchError.Regex.fromObject(data.regex as any);
            }
            if (data.input != null) {
                message.input = SearchError.Input.fromObject(data.input as any);
            }
            if (data.grab != null) {
                message.grab = SearchError.Grab.fromObject(data.grab);
            }
            if (data.aborted != null) {
                message.aborted = SearchError.Aborted.fromObject(data.aborted as any);
            }
            return message;
        }
        toObject() {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_grab) writer.writeMessage(6, this.grab, () => this.grab.serialize(writer));
            if (this.has_aborted)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(
                            message.config,
                            () => (message.config = SearchError.Config.deserialize(reader)),
                        );
                        break;
                    case 2:
                        reader.readMessage(
                            ...
                            () =>
                                (message.communication =
                                    SearchError.Communication.deserialize(reader)),
                        );
                        break;
                    case 3:
                        reader.readMessage(
                            ...
                            () =>
                                (message.io_operation =
                                    SearchError.IoOperation.deserialize(reader)),
                        );
                        break;
                    case 4:
                        reader.readMessage(
                            message.regex,
                            () => (message.regex = SearchError.Regex.deserialize(reader)),
                        );
                        break;
                    case 5:
                        reader.readMessage(
                            message.input,
                            () => (message.input = SearchError.Input.deserialize(reader)),
                        );
                        break;
                    case 6:
                        reader.readMessage(
                            message.grab,
                            () => (message.grab = SearchError.Grab.deserialize(reader)),
                        );
                        break;
                    case 7:
                        reader.readMessage(
                            message.aborted,
                            () => (message.aborted = SearchError.Aborted.deserialize(reader)),
                        );
                        break;
                    default:
                        reader.skipField();
    ...
    export namespace SearchError {
        ...
        export class Regex extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): Regex {
        ...
        export class Input extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): Input {
        ...
        export class Grab extends pb_1.Message {
            ...
            static fromObject(data: {
                ...
                const message = new Grab({
                    error: GrabError.fromObject(data.error as any),
                });
                return message;
            }
            toObject() {
                ...
                while (reader.nextField()) {
                    ...
                    switch (reader.getFieldNumber()) {
                        case 1:
                            reader.readMessage(
                                message.error,
                                () => (message.error = GrabError.deserialize(reader)),
                            );
                            break;
                        default:
                            reader.skipField();
        ...
        export class Aborted extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): Aborted {
    ...
    export class NativeError extends pb_1.Message {
        ...
        get kind() {
            return pb_1.Message.getField(this, 2) as NativeErrorKind;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.has_severity) writer.writeEnum(1, this.severity);
            if (this.has_kind) writer.writeEnum(2, this.kind);
            if (this.has_message && this.message.length) writer.writeString(3, this.message);
            if (!w) return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): NativeError {
            const reader =
                    bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new NativeError();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
    ...
    export class ComputationError extends pb_1.Message {
        ...
        constructor(
            ...
            if (!Array.isArray(data) && typeof data == 'object') {
                ...
                if (
                    'operation_not_supported' in data &&
                    data.operation_not_supported != undefined
                ) {
        ...
        get destination_path() {
            return pb_1.Message.getWrapperField(
                ...
                1,
            ) as ComputationError.DestinationPath;
        }
        ...
        get session_creating_fail() {
            return pb_1.Message.getWrapperField(
                ...
                2,
            ) as ComputationError.SessionCreatingFail;
        }
        ...
        get communication() {
            return pb_1.Message.getWrapperField(
                ...
                3,
            ) as ComputationError.Communication;
        }
        ...
        get operation_not_supported() {
            return pb_1.Message.getWrapperField(
                ...
                4,
            ) as ComputationError.OperationNotSupported;
        }
        ...
        get io_operation() {
            return pb_1.Message.getWrapperField(
                ...
                5,
            ) as ComputationError.IoOperation;
        }
        ...
        get invalid_data() {
            return pb_1.Message.getWrapperField(
                ...
                6,
            ) as ComputationError.InvalidData;
        }
        ...
        get invalid_args() {
            return pb_1.Message.getWrapperField(
                ...
                7,
            ) as ComputationError.InvalidArgs;
        }
        ...
        get multiple_init_call() {
            return pb_1.Message.getWrapperField(
                ...
                11,
            ) as ComputationError.MultipleInitCall;
        }
        ...
        get session_unavailable() {
            return pb_1.Message.getWrapperField(
                ...
                12,
            ) as ComputationError.SessionUnavailable;
        }
        ...
        static fromObject(data: {
            destination_path?: ReturnType<
                typeof ComputationError.DestinationPath.prototype.toObject
            >;
            session_creating_fail?: ReturnType<
                typeof ComputationError.SessionCreatingFail.prototype.toObject
            >;
            communication?: ReturnType<typeof ComputationError.Communication.prototype.toObject>;
            operation_not_supported?: ReturnType<
                typeof ComputationError.OperationNotSupported.prototype.toObject
            >;
            ...
            multiple_init_call?: ReturnType<
                typeof ComputationError.MultipleInitCall.prototype.toObject
            >;
            session_unavailable?: ReturnType<
                typeof ComputationError.SessionUnavailable.prototype.toObject
            >;
            ...
            if (data.destination_path != null) {
                message.destination_path = ComputationError.DestinationPath.fromObject(
                    data.destination_path,
                );
            }
            if (data.session_creating_fail != null) {
                message.session_creating_fail = ComputationError.SessionCreatingFail.fromObject(
                    data.session_creating_fail,
                );
            }
            if (data.communication != null) {
                message.communication = ComputationError.Communication.fromObject(
                    data.communication as any,
                );
            }
            if (data.operation_not_supported != null) {
                message.operation_not_supported = ComputationError.OperationNotSupported.fromObject(
                    data.operation_not_supported as any,
                );
            }
            if (data.io_operation != null) {
                message.io_operation = ComputationError.IoOperation.fromObject(
                    data.io_operation as any,
                );
            }
            ...
            if (data.invalid_args != null) {
                message.invalid_args = ComputationError.InvalidArgs.fromObject(
                    data.invalid_args as any,
                );
            }
            if (data.process != null) {
                message.process = ComputationError.Process.fromObject(data.process as any);
            }
            if (data.protocol != null) {
                message.protocol = ComputationError.Protocol.fromObject(data.protocol as any);
            }
            if (data.search_error != null) {
                message.search_error = SearchError.fromObject(data.search_error);
            }
            if (data.multiple_init_call != null) {
                message.multiple_init_call = ComputationError.MultipleInitCall.fromObject(
                    data.multiple_init_call,
                );
            }
            if (data.session_unavailable != null) {
                message.session_unavailable = ComputationError.SessionUnavailable.fromObject(
                    data.session_unavailable,
                );
            }
            if (data.native_error != null) {
                message.native_error = NativeError.fromObject(data.native_error as any);
            }
            if (data.grabbing != null) {
                message.grabbing = ComputationError.Grabbing.fromObject(data.grabbing);
            }
            if (data.sde != null) {
                message.sde = ComputationError.Sde.fromObject(data.sde as any);
            }
            return message;
        }
        toObject() {
            const data: {
                ...
                communication?: ReturnType<
                    typeof ComputationError.Communication.prototype.toObject
                >;
                operation_not_supported?: ReturnType<
                    typeof ComputationError.OperationNotSupported.prototype.toObject
                >;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_destination_path)
                writer.writeMessage(1, this.destination_path, () =>
                    this.destination_path.serialize(writer),
                );
            if (this.has_session_creating_fail)
                writer.writeMessage(2, this.session_creating_fail, () =>
                    this.session_creating_fail.serialize(writer),
                );
            if (this.has_communication)
                writer.writeMessage(3, this.communication, () =>
                    this.communication.serialize(writer),
                );
            if (this.has_operation_not_supported)
                writer.writeMessage(4, this.operation_not_supported, () =>
                    this.operation_not_supported.serialize(writer),
                );
            if (this.has_io_operation)
                writer.writeMessage(5, this.io_operation, () =>
                    this.io_operation.serialize(writer),
                );
            if (this.has_invalid_data)
                writer.writeMessage(6, this.invalid_data, () =>
                    this.invalid_data.serialize(writer),
                );
            if (this.has_invalid_args)
                writer.writeMessage(7, this.invalid_args, () =>
                    this.invalid_args.serialize(writer),
                );
            if (this.has_process)
            ...
            if (this.has_search_error)
                writer.writeMessage(10, this.search_error, () =>
                    this.search_error.serialize(writer),
                );
            if (this.has_multiple_init_call)
                writer.writeMessage(11, this.multiple_init_call, () =>
                    this.multiple_init_call.serialize(writer),
                );
            if (this.has_session_unavailable)
                writer.writeMessage(12, this.session_unavailable, () =>
                    this.session_unavailable.serialize(writer),
                );
            if (this.has_native_error)
                writer.writeMessage(13, this.native_error, () =>
                    this.native_error.serialize(writer),
                );
            if (this.has_grabbing)
                writer.writeMessage(14, this.grabbing, () => this.grabbing.serialize(writer));
            if (this.has_sde) writer.writeMessage(15, this.sde, () => this.sde.serialize(writer));
            if (!w) return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ComputationError {
            const reader =
                    bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                message = new ComputationError();
            while (reader.nextField()) {
                if (reader.isEndGroup()) break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(
                            ...
                            () =>
                                (message.destination_path =
                                    ComputationError.DestinationPath.deserialize(reader)),
                        );
                        break;
                    case 2:
                        reader.readMessage(
                            message.session_creating_fail,
                            () =>
                                (message.session_creating_fail =
                                    ComputationError.SessionCreatingFail.deserialize(reader)),
                        );
                        break;
                    case 3:
                        reader.readMessage(
                            ...
                            () =>
                                (message.communication =
                                    ComputationError.Communication.deserialize(reader)),
                        );
                        break;
                    case 4:
                        reader.readMessage(
                            ...
                            () =>
                                (message.operation_not_supported =
                                    ComputationError.OperationNotSupported.deserialize(reader)),
                        );
                        break;
                    case 5:
                        reader.readMessage(
                            ...
                            () =>
                                (message.io_operation =
                                    ComputationError.IoOperation.deserialize(reader)),
                        );
                        break;
                    case 6:
                        reader.readMessage(
                            ...
                            () =>
                                (message.invalid_data =
                                    ComputationError.InvalidData.deserialize(reader)),
                        );
                        break;
                    case 7:
                        reader.readMessage(
                            ...
                            () =>
                                (message.invalid_args =
                                    ComputationError.InvalidArgs.deserialize(reader)),
                        );
                        break;
                    case 8:
                        reader.readMessage(
                            message.process,
                            () => (message.process = ComputationError.Process.deserialize(reader)),
                        );
                        break;
                    case 9:
                        reader.readMessage(
                            message.protocol,
                            () =>
                                (message.protocol = ComputationError.Protocol.deserialize(reader)),
                        );
                        break;
                    case 10:
                        reader.readMessage(
                            message.search_error,
                            () => (message.search_error = SearchError.deserialize(reader)),
                        );
                        break;
                    case 11:
                        reader.readMessage(
                            message.multiple_init_call,
                            () =>
                                (message.multiple_init_call =
                                    ComputationError.MultipleInitCall.deserialize(reader)),
                        );
                        break;
                    case 12:
                        reader.readMessage(
                            ...
                            () =>
                                (message.session_unavailable =
                                    ComputationError.SessionUnavailable.deserialize(reader)),
                        );
                        break;
                    case 13:
                        reader.readMessage(
                            message.native_error,
                            () => (message.native_error = NativeError.deserialize(reader)),
                        );
                        break;
                    case 14:
                        reader.readMessage(
                            message.grabbing,
                            () =>
                                (message.grabbing = ComputationError.Grabbing.deserialize(reader)),
                        );
                        break;
                    case 15:
                        reader.readMessage(
                            message.sde,
                            () => (message.sde = ComputationError.Sde.deserialize(reader)),
                        );
                        break;
                    default:
                        reader.skipField();
    ...
    export namespace ComputationError {
        ...
        export class SessionCreatingFail extends pb_1.Message {
            ...
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SessionCreatingFail {
                const reader =
                        bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                    message = new SessionCreatingFail();
                while (reader.nextField()) {
                    if (reader.isEndGroup()) break;
                    switch (reader.getFieldNumber()) {
                        default:
        ...
        export class OperationNotSupported extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): OperationNotSupported {
            ...
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): OperationNotSupported {
                const reader =
                        bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                    message = new OperationNotSupported();
                while (reader.nextField()) {
                    if (reader.isEndGroup()) break;
                    switch (reader.getFieldNumber()) {
                        case 1:
        ...
        export class InvalidArgs extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): InvalidArgs {
        ...
        export class Process extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): Process {
        ...
        export class Protocol extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): Protocol {
        ...
        export class SessionUnavailable extends pb_1.Message {
            ...
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SessionUnavailable {
                const reader =
                        bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
                    message = new SessionUnavailable();
                while (reader.nextField()) {
                    if (reader.isEndGroup()) break;
                    switch (reader.getFieldNumber()) {
                        default:
        ...
        export class Sde extends pb_1.Message {
            ...
            static fromObject(data: { message: string }): Sde {
