...
export namespace progress {
    ...
    export class LifecycleTransition extends pb_1.Message {
        ...
        static fromObject(data: {
            ...
            if (data.started != null) {
                message.started = Started.fromObject(data.started as any);
            }
            if (data.ticks != null) {
                message.ticks = TicksWithUuid.fromObject(data.ticks as any);
            }
            if (data.stopped != null) {
                message.stopped = Stopped.fromObject(data.stopped as any);
            }
            return message;
        }
        toObject() {
    ...
    export class Started extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_alias && this.alias.length) writer.writeString(2, this.alias);
            if (!w) return writer.getResultBuffer();
        }
    ...
    export class TicksWithUuid extends pb_1.Message {
        ...
        static fromObject(data: {
            ...
            const message = new TicksWithUuid({
                uuid: data.uuid,
                ticks: Ticks.fromObject(data.ticks as any),
            });
            return message;
        }
        toObject() {
