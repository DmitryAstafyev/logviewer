...
export { ScrollBoxModule } from './lib/scrollbox/module';

export * from './lib/tabs/component';
export * from './lib/tabs/options';
export * from './lib/tabs/service';
export { TabsModule } from './lib/tabs/module';

export * from './lib/complex.service';
export { ComplexModule } from './lib/complex.module';

export * from './lib/dynamic/component';
export * from './lib/frame/component';
export * from './lib/containers.service';
export { ContainersModule } from './lib/containers.module';
...
export { ComplexScrollBoxSBHComponent } from './lib/scrollbox/sbh/component';
export { ComplexScrollBoxSBVComponent } from './lib/scrollbox/sbv/component';
export { TabsListComponent } from './lib/tabs/list/component';
export { TabContentComponent } from './lib/tabs/content/component';
